...
# zerotier_network_id = "60ee7c034a63b734"
# zerotier_client = zerotier.Client()
# zerotier_client.set_auth_header("Bearer 32sST0Tf0eRLJUyR98DSpjfe9ROy4qB0")

# while zerotier_client.get_node_status() != "OK":
#     pass

# zerotier_network = zerotier_client.get_network(zerotier_network_id)
# for member in zerotier_network.get_members():
#     if member.online and member.name == "Prueba":
#         zerotier_ip_address = member.ipAssignments[0] 

ip_address = "172.24.241.111"
port = "3308"
